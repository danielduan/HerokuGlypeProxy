Readme file for BlackLens v0.03 glype template by www.glypedesigns.com
...
1. Unzip the zip file. It will create a new directory named "BlackLens"
   This directory will contain the theme files.
   
2. The config.php file in the BlackLens directory must be edited to customize
   the template. Edit the file manually or use the online theme customyzer 
   at http://www.glypedesigns.com/customyzer/?t=blacklens .
   
3. Upload the blacklens directory to your [glype directory]/themes 
   directory. The theme files should now be in 
   [glype directory]/themes/blacklens
