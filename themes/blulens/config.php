...
defined("siteNAME") or define("siteNAME",$themeReplace['site_name']="circumvent.us");
...
$themeReplace['index_meta_description']="Proxy for accessing blocked sites like myspace using this web browsing service";

$themeReplace['index_meta_keywords']="myspace browsing, web browsing, glype php, proxy, filtered, blocked, internet, youtube, facebook, myspace";
...
$themeReplace['index_h1']="<span id=\"black\">circumvent</span>.<span id=\"pink\">us</span>";
...
<!--example links-->
<!--
<a href="http://www.greenunblocker.com" title="unblocker">Unblocker</a>
...
# h3 tag.
$themeReplace['index_description_heading']="About this web proxy:";
...
#Right sidebar of the theme. 
$themeReplace['index_sidebar']=<<<OUT
<!--enter code for the right sidebar-->
<!--example links-->
<!--
<h3>Other unblockers </h3>
<ul>
	<li>
		<a href="http://www.blueunblocker.com" title="unblocker">unblocker</a>
	</li>
	<li>
		<a href="http://www.planetunblock.com" title="unblock websites">Unblock websites</a>
	</li>
		
	<li>
		<a href="https://www.dailyunblocker.com" title="unblocker">Unblocker</a>
	</li>
